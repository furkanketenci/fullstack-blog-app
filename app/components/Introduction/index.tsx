...
const Introduction = () => {
    return (
        <div className={styles.introductionContainer}>
            ...
            <div className={styles.desc}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Esse atque fugiat maiores distinctio cum dolore dolores sint vero corrupti magnam, nihil laudantium rem fugit. </div>
        </div>
    );
}
